    ...
    try {
      if (job) {
        await updateJob.mutateAsync({
          id: job.id,
          job: { name, cron_expression: cronExpression, command, description },
        });
      ...
      <div className="relative w-full max-w-[520px] rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5 px-4 py-3.5">
          ...
          <div className="space-y-1.5">
            ...
            {nextRuns.length > 0 && (
              <div className="rounded bg-[hsl(var(--secondary))] px-2.5 py-2">
                <p className="mb-1 text-[12px] font-medium text-[hsl(var(--muted-foreground))]">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={2}
              className="focus-ring w-full resize-none rounded border border-[hsl(var(--input))] bg-transparent px-2.5 py-[5px] text-[14px] placeholder:text-[hsl(var(--muted-foreground))]/40"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-1.5 pt-0.5">
            ...
            <button
              type="submit"
              disabled={!validation?.is_valid || isPending}
